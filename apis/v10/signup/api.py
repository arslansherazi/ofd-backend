...
class Signup(BasePostResource):
    ...
    def populate_request_arguments(self):
        ...
        if self.user_type == MERCHANT_USER_TYPE:
            ...
            self.menus_limit = int(self.request_args.get('menus_limit'))
            self.items_limit = int(self.request_args.get('items_limit'))
            ...
            self.is_open_all_day = bool(int(self.request_args.get('is_open_all_day')))
            self.is_open_all_week = bool(int(self.request_args.get('is_open_all_week')))
        else:
