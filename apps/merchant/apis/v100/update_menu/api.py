from apps.merchant.apis.v100.update_menu.validator import UpdateMenuValidator
...
class UpdateMenu(BasePostResource):
    ...
    def populate_request_arguments(self):
        ...
        self.is_activate = self.request_args.get('is_activate')
        self.is_deactivate = self.request_args.get('is_deactivate')
